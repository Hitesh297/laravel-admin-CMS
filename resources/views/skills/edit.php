...
<section class="w3-padding">
    ...
    <form method="post" action="/console/skills/edit/<?= $skill->id ?>" novalidate>
        ...
        <input class="form-control" type="text" name="fontawesomeHTML" id="fontawesomeHTML" value="<?= htmlentities(old('fontawesomeHTML', $skill->fontawesomeHTML)) ?>">
        <span style="color:red;"><?= $errors->first('fontawesomeHTML'); ?></span>

        <br>

        <label for="type">Type:</label>
        <input class="form-control" type="text" name="type" id="type" value="<?= old('type', $skill->type) ?>">
        <span style="color:red;"><?= $errors->first('type'); ?></span>

        <br>

        <label for="details">Details:</label>
        <textarea class="form-control" type="text" name="details" id="details" rows="100"><?= old('details', $skill->details) ?></textarea>
        ...
        <input class="form-control" type="number" name="sequence" id="sequence" value="<?= old('sequence', $skill->sequence) ?>">
